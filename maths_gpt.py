...
prompt="""
You are a agent tasked for solving users mathematical question. Logically arrive aat the solution and provide a detailed explanation and explain it pointwise for the question below.
Question:{question}
Answer:
